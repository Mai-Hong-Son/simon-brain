...
- [[ok2ship-ai]] — 🚀 product: three-repo topology, locked decisions, mockup-fidelity + tsc -b lessons, Data Mapping gate→built, conflicting-spec-markers + session-revocation lessons.
